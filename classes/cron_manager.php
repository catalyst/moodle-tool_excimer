...
class cron_manager {
    ...
    public static function set_callbacks(\ExcimerProfiler $profiler, \ExcimerTimer $timer, float $started): void {
        self::$sampletime = $started;
        $timer->setCallback(function() use ($profiler, $started) {
    ...
    /**
     * Examines a series of samples generated by the profiler.
     *
     * For each sample, the logic represents the following:
     *
     ...
     * @param float $started
     */
    public static function on_interval(\ExcimerProfiler $profiler, float $started): void {
        $log = $profiler->flush();
